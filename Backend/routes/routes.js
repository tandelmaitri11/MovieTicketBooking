...
router.get("/me/favorites", protect, authController.getFavorites);
router.post("/me/favorites", protect, authController.addFavorite);
router.delete("/me/favorites/:movieId", protect, authController.removeFavorite);
