import { ChartLineIcon, CircleDollarSignIcon, PlayCircleIcon, StarIcon, User2Icon } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    { title: "Total Users" , value: dashboardData.totalUser || "0", icon: User2Icon },
      ...
      <div className="relative flex flex-wrap gap-4 mt-6">
        <div className="flex flex-wrap gap-4 w-full">
          {dashboardCards.map((card,index) => (
            <div key={index} className='flex items-center justify-between px-4 py-3 bg-primary/10 borderd borderd-primary/20 rounded-md max-w-50 w-full'>
              <div>
